        ...
        <div class="space-y-4">
          ...
          <div v-if="isGuestLoginEnabled" class="space-y-3">
            <input
              ...
              maxlength="50"
              class="w-full px-3 py-3 text-sm rounded-lg border border-border bg-background text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
