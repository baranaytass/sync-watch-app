<template>
  <div class="h-full flex flex-col">
    <!-- Chat Header -->
    <div class="flex-shrink-0 px-4 py-3 bg-gray-50 dark:bg-gray-750 border-b border-gray-200 dark:border-gray-600">
...
const handleSendMessage = (message: string) => {
  console.log(`🔥 ChatPanel: handleSendMessage called with: "${message}"`)
